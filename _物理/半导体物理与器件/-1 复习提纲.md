...
9. 载流子密度与温度、禁带宽度以及与费米能级位置的关系；
    ![[Pasted image 20250524143520.png|400]]![[Pasted image 20250524143530.png|400]]
...
14. 试列出几种常见的半导体界面,并分别指出这些界面在构成pn结时，有什么特点？
    ...
    晶粒间界
        晶轴不同（位错）的晶粒相接形成的界面
        产生自由悬挂键，更容易获得或者丢失电子
        禁带宽度发生变化$$\Delta\varepsilon_{g}=G\left( \frac{\Delta V}{V} \right)_{dil} \frac{\partial \varepsilon_{g}}{\partial p}$$
